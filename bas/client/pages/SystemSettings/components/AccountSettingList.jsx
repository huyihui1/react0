...
class AccountSettingList extends Component {
  ...
  handleClick = (text) => {
    if (text === '添加') {
      ...
      this.props.actions.deleteSystemSetting({ account_id: '1', id: this.state.itemId })
        .then(res => {
          console.log(res);
  ...
  fetchData(caseId = this.props.caseId) {
    ...
    actions.fetchSystemSettings({ type: 'account' }, {
      query: {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.systemSettings.accountMeta && nextProps.systemSettings.accountMeta.page) {
      this.setState({
        current: nextProps.systemSettings.accountMeta.page.current,
        pageTotal: nextProps.systemSettings.accountMeta.page.total,
      });
    }
  }
    ...
    return (
      <div style={styles.container}>
        ...
        <Table
          ...
          dataSource={systemSettings.accountItems}
