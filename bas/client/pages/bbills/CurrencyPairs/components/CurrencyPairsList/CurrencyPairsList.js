...
componentWillReceiveProps(nextProps) {
  console.log(nextProps.currencyPairs)
  console.log(this.props.currencyPairs)
   if (nextProps.currencyPairs.pageFirst ==1 &&nextProps.currencyPairs.meta){
    ...
    this.setState({pageTotal: nextProps.currencyPairs.meta.page.total,
      ...
      if (nextProps.currencyPairs.meta.page.current !== 1){
        this.setState({
          current: nextProps.currencyPairs.meta.page.current
        })
      }
    })
