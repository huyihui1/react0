...
class DailyPbills extends PureComponent {
  ...
  async componentDidMount() {
    const starteddayChart = echarts.init(document.getElementById("startedday"), 'light');
    ...
    if (this.props.componentProps && this.props.componentProps.opt && JSON.stringify(this.props.componentProps.opt) !== JSON.stringify(this.state.componentPropsOpt)) {
      this.props.searchStartedday(this.props.caseId, {...this.props.componentProps.opt}, this.props.componentProps && this.props.componentProps.url).then(res => {
        if (res) {
  ...
  initC3(starteddayChart, data, params) {
    ...
    let that = this;
    params.opt.criteria.started_day = ['IN', xData[0]];
    ...
    starteddayChart.on('click', function (e) {
      ...
      params.opt.criteria.started_day = ['IN', e.name];
    ...
    return (
      <Fragment>
        ...
        <div id="windowScrollerTable2">
          <div id="startedday" style={{height: '350px', width: '100%'}}/>
