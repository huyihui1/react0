...
import InCommonsList from '../PBAnalyze/components/InfiniteScrollGrid/PBAnalyzeList';
...
class Meetanalyze extends Component {
  static displayName = 'Meetanalyze';
    ...
    return (
      <DocumentTitle title={this.meta.title}>
        <div className="pb-analyze">
          ...
          <InCommonsList pageTitle={this.meta.title} pagingType={this.updatePaging} countMessage={this.updatePbTableMessage} getWindowScroller={this.getWindowScroller} componentProps={{url: `/cases/${this.props.caseId}/pbills/analyze/meets`}} />
        </div>
      </DocumentTitle>
    );
  }
