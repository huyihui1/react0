...
export default class ScrollTitle extends Component {
  componentDidMount() {
    document.querySelector('#scrollTitle').style.width =
      document.querySelector('.ReactVirtualized__Table .ReactVirtualized__Table__headerRow').style.width;
  }
  ...
  render() {
    return (
      ...
      >
        ...
        <div className="ReactVirtualized__Table__headerColumn" role="columnheader" style={{ flex: '0 1 140px' }}><span
          className="ReactVirtualized__Table__headerTruncatedText"
          title="日期"
        >日期
                                                                                                                 </span>
