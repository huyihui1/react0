...
import AllChartTitle from './AllChartTitle';
...
class SearchBar extends Component {
  ...
  resetSearch(value) {
    ...
    // this.porps.actions.clearPBStatStoreChart();
  }
  ...
  popupCustomIcon = () => {
    Dialog.confirm({
      title: '提示',
      content: <div style={{lineHeight: '20px', fontSize: '13px', color: '#F1C826'}}>本次查找没有指定本方号码或者对方号码，可能会导致<br/>结果数据过大从而导致响应时间较。确定继续查找吗?
      </div>,
      messageProps: {
        type: 'warning'
      },
      ...
      <div>
                ...
                >
                  <div style={styles.container2}>
                    ...
                    <div>
                      ...
                      {
                        this.props.isHide ? null : <AllChartTitle onChartInptRef={this.getChartInptRef}/>
                      }
                      <br/>
                    </div>
        ...
        </div>
        {
          this.state.isShow ? null : this.state.conditions.length > 0 ? (
            ...
            this.props.button ? (
              <PageTitle title={this.props.title} tour={this.props.tour} collapsed={true} button={this.props.button}/>
            ) : (
              <PageTitle title={this.props.title} tour={this.props.tour} collapsed={true}/>
            )
          )
        }
...
export default connect(
  ...
  dispatch => ({
    actions: bindActionCreators({
      ...actions, ...pbStatActions, ...labelPNActions, ...labelCellActions,
      clearItems
    }, dispatch),
  }),
)(SearchBar);
